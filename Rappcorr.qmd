---
title: "Random Forest"
categories: [Lien intéractif, Arbre de décision, Importance des variables, Distribution des profondeur minimal,]
toc: true
toc-location: right
toc-depth: 2
---
...
<hr style="border: 1px solid black; width: 100%; margin: 20px 0;">
 ...
 <div class="card" style="border: 2px solid #000; border-radius: 10px; padding: 10px; display: flex; flex-direction: column; align-items: center; width: 100%; max-width: 500px; margin: 0 auto;">
  ...
  <img src="RF.png" alt="Variables complètes" style="width: 100%; height: auto; display: block; border-radius: 10px;" />
...
## Importance des variables
 ...
 <div class="card" style="border: 2px solid #000; border-radius: 10px; padding: 10px; display: flex; flex-direction: column; align-items: center; width: 100%; max-width: 500px; margin: 0 auto;">
  ...
  <img src="imp.png" alt="Variables complètes" style="width: 100%; height: auto; display: block; border-radius: 10px;" />
<p style="font-size: 0.85em; color: #333; margin-top: 10px; text-align: justify; line-height: 1.6;">
...
## Distribution des profondeurs minimales
 ...
 <div class="card" style="border: 2px solid #000; border-radius: 10px; padding: 10px; display: flex; flex-direction: column; align-items: center; width: 100%; max-width: 500px; margin: 0 auto;">
  ...
  <img src="distribution.png" alt="Variables complètes" style="width: 100%; height: auto; display: block; border-radius: 10px;" />
<p style="font-size: 0.85em; color: #333; margin-top: 10px; text-align: justify; line-height: 1.6;">
  Nous analysons les <strong>profondeurs minimales et moyennes</strong> des variables. La <strong>taille d'entreprise</strong> et la <strong>rémunération des salariés</strong> sont sélectionnées près de la <strong>racine des arbres</strong>, tandis que des variables comme le <strong>code Nace</strong> et le <strong>taux de change</strong> ont un rôle <strong>secondaire</strong>. Le modèle enregistre un <strong>taux d’erreur de 14%</strong> avec une <strong>sensibilité de 85%</strong> et une <strong>spécificité de 87%</strong>.
</p>
</div>
