...
categories: [Lien interactif, Base de données, Visualisation exploratoire, Regression avec intéraction, Rapport de corrélation, Régression taux de défaillance]
toc: true
toc-location: right
toc-depth: 2
---
...
<li><strong>Variables Latentes :</strong> Conjoncture économique, GES et Catastrophes naturelles <a href="ACP.pdf" target="_blank">(cliquez ici pour l'analyse)</a></li>
</ul>
</p>
</div>
...
<div style="display: flex; justify-content: center; gap: 20px; margin: 50px auto;">
  ...
  <p style="margin-top: 10px; font-size: 0.9em; color: #333;">Répartition des Taux de Défaillance sur 3 Mois par Secteur d'Activité (14 Secteurs)</p>
    
  <img src="hist2.png" alt="Image 1" style="width: 355px; height: auto; margin-bottom: 10px;" />
    
  <p style="font-size: 0.85em; color: #333; margin-top: 10px; text-align: justify; line-height: 1.6;">Trois secteurs se démarquent particulièrement : **Transports et entreposage**, **Construction**, et **Hébergement et restauration**. Cette observation est cohérente, car ces secteurs ont été fortement impactés, notamment durant la crise du COVID-19, ce qui a pu fortement joué sur la défaillance de ces entreprises
    </p>
...
<div style="display: flex; justify-content: center; gap: 20px; margin: 50px auto; flex-wrap: wrap;">
  ...
  <img src="MCO6.png" alt="MCO6" style="max-width: 100%; margin: 20px 0;" />
  <ul style="list-style-type: none; padding: 0; font-size: 0.8em; color: #333;">
  ...
  <li style="margin-bottom: 10px;"><strong>Indice des prix des matières première :</strong> Impact négatif modéré, suggère une pression sur les marges.</li>
  ...
  <li style="margin-bottom: 10px;"><strong>Facteurs conjoncturels positifs:</strong> Confiance des ménages, rémunération des salariés.</li>
  <li style="margin-bottom: 10px;"><strong>Gestion proactive :</strong> Nécessaire pour anticiper les risques et stabiliser les finances.</li>
  </ul>
  ...
  <p style="font-size: 0.7em; color: #777;">Lexique :</p>
  <ul style="list-style-type: none; padding: 0; font-size: 0.7em; color: #777;">
  <li style="margin-bottom: 5px;">Jaune : Significatif au seuil de 10%</li>
  <li style="margin-bottom: 5px;">Vert : Significatif au seuil de 1 et 5%</li>
  </ul>
  </div>
</div>
